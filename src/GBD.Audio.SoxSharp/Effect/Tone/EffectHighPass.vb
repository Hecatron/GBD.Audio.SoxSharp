Namespace Effect.Tone
    ...
    ''' <summary>
    '''  A highPass filter which allows all frequencies through above a certain limit This is useful
    '''  for removing the DC offset on a VC / VOX file when converting to MP3 / Wav.
    ''' </summary>
    Public Class EffectHighPass
        Inherits EffectBase
...
#Region "Properties"
        ...
        Protected Overrides Property _SoxEffectName As String = "highpass"
        ...
        "High Pass Filter, that can be used to allow all frequencies through except for those " & _
        "below the specified frequency. " & vbCrLf & _
        "Note that VC / Vox's from an IVR tend to have a lump at 10Hz that usually needs to be removed" & _
        vbCrLf & vbCrLf & _
        "Apply a high-pass filter with 3dB point frequency. The filter can be either single-pole (with -1) " & _
