...
Namespace swig
    ...
    Public Class SWIGTYPE_p_f_p_struct_sox_format_t_p_int_size_t__size_t
        ...
        Friend Shared Function getCPtr(ByVal obj As SWIGTYPE_p_f_p_struct_sox_format_t_p_int_size_t__size_t) As HandleRef
