...
Namespace swig
    ...
    Public Class SWIGTYPE_p_f_void__p_sox_format_handler_t
        ...
        Friend Shared Function getCPtr(ByVal obj As SWIGTYPE_p_f_void__p_sox_format_handler_t) As HandleRef
