...
Namespace swig
    ...
    Public Class SWIGTYPE_p_f_p_struct_sox_effect_t_int_a___p_char__int
        ...
        Friend Shared Function getCPtr(ByVal obj As SWIGTYPE_p_f_p_struct_sox_effect_t_int_a___p_char__int) As HandleRef
