...
Namespace swig
    ...
    Public Class SWIGTYPE_p_f_p_struct_sox_format_t_unsigned_long__int
        ...
        Friend Shared Function getCPtr(ByVal obj As SWIGTYPE_p_f_p_struct_sox_format_t_unsigned_long__int) As HandleRef
