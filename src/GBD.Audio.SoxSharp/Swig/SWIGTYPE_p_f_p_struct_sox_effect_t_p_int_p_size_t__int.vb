...
Namespace swig
    ...
    Public Class SWIGTYPE_p_f_p_struct_sox_effect_t_p_int_p_size_t__int
        ...
        Friend Shared Function getCPtr(ByVal obj As SWIGTYPE_p_f_p_struct_sox_effect_t_p_int_p_size_t__int) As HandleRef
